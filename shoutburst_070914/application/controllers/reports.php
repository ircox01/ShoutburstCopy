...
class Reports extends CI_Controller {
	...
	public function query_builder()
	{
		...
		if( $report_type == 'detail' )
		{
			...
			// NX
			$select = "DATE_FORMAT(date_time,'%d/%m/%Y') as date_time,".$select;
		}		
...
echo $wciframe;
		...
		{			
			...
			//draw data
			$select = "IFNULL(full_name,'Not Found') AS full_name,IFNULL(user_pin,'Not Found') AS user_pin,q1,q2,q3,average_score,recording,tag_name,full_name AS agentName , cc.logo AS logo";

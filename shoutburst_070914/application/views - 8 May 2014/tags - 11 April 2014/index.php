				...
				<tbody>
					<?php foreach ($tags as $key){ ?>
					 <tr class="odd_gradeX">
						...
						<td align="center">
							<?php echo anchor("tags/edit/".$key->tag_id,'<span class="glyphicon black glyphicon-pencil"></span>')?>
							|
							<?php 
								if($key->status==1){
									echo anchor("tags/delete/".$key->tag_id."/disable",'<span class="glyphicon red glyphicon-remove"></span>', array('class' => 'confirm','style'=>'','id'=>"disable__".$key->tag_id));
								}else{
									echo anchor("tags/delete/".$key->tag_id."/enable",'<span class="glyphicon green glyphicon-ok"></span>', array('class' => 'confirm','style'=>'','id'=>"enable__".$key->tag_id));
								}
							?>

		  ...
		  <div class="col-sm-6">
			<div class="form-horizontal sb-form">
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" value="<?php if(isset($reportData['report_name'])){ echo $reportData['report_name'];}?>" name="report_name" id="report_name" class="sb-control" placeholder="Report name"  />
					...
					<div class="col-sm-6">
					 <div>
					     <label style>Start Date</label>
					  	 <input type="text" name='start_date' id="datepicker" class='datePicker' value="<?php if(isset($reportData['custom_start_date'])){echo $reportData['custom_start_date'];} ?>">
					 </div>
					 <div>
					     <label>End Date</label>
					     <input type="text"  name='end_date' id="datepicker2" class='datePicker' value="<?php if(isset($reportData['custom_end_date'])){echo $reportData['custom_end_date'];} ?>">
					  </div>
					...
					<div class="col-sm-6">
					 <div>
					     <label style>Select Date:</label>
					  	 <input type="text" name='custom_date' id="custom_date" class='datePicker' value="<?php if(isset($reportData['report_period_date'])){echo $reportData['report_period_date'];} ?>">
					 </div>
				...
				<div class="form-group" id="output_requirements_div" style="display:none;">
					...
					<div class="col-sm-6">
						<select name="op_req" class="sb-control" id="op_req" onChange='outputRequirementCheck();'>
							<option value="data"  <?php if(isset($reportData['op_req'])&&$reportData['op_req']=='data'){echo "selected='selected'";}?> >Data</option>
	    ...
	    <div class="row content-body">
		  <div class="col-sm-12">
			...
			<div class="row">
				...
				<div class="form-horizontal sb-form">
					<div class="form-group">
						<div class="col-xs-6"><input type="button" class="sb-btn sb-btn-white" value="Back" name="btn_step_1" id="btn_step_1" onclick="next_step(1);" /></div>
						<div class="col-xs-6">
	...
	<div id="step_3" style="display:none;">
	    ...
	    <div class="row content-body">
		  <div class="col-sm-12">
			...
			<a href="#" id="addRow"><i class="icon-plus-sign icon-white"></i> Add</p></a>
	...
	<div id="step_4" style="display:none;">
	    ...
	    <div class="row content-body">
		  <div class="col-sm-6">			
			...
			<div class="form-horizontal sb-form">
				<div class="form-group">
					<div class="col-xs-6"><input type="button" class="sb-btn sb-btn-white" value="Back" name="btn_step_3" id="btn_step_3" onclick="next_step(3);"></div>
					<div class="col-xs-6">						
				...
				<div class="form-horizontal sb-form querySaveDivRegion">
				  <div class="form-group">
					...
					<div class="col-xs-6">
					 		...
					 		<input type="button" class="sb-btn sb-btn-green reportSave" value="Update Report" name="btn_step_save" id="btn_step_save" onclick="next_step('update'); liveChartIntervalRemove();">
					</div>
				  </div>
				</div><!-- .form-horizontal .sb-form -->
			</div><!-- .col-sm-12 -->

            ...
            <div class="col-sm-12">
                <div class="form-horizontal sb-form querySaveDivRegion">
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <input type="button" class="sb-btn sb-btn-green reportSave" value="Save" name="btn_step_save" id="btn_step_save" onclick="next_step('save',5); ">                            
                        </div>
                    </div>
                </div>
                <!-- .form-horizontal .sb-form -->
		...
		$html =
	     ...
	     '   <div class="col-xs-3">'+
	        '    <select class="span2 sb-control" id="filter1_'+div_len+'" name="filter[]">'+
		        ...
		        '</div>'+
		        '<div class="col-xs-3">'+
		            '<input class="span3 sb-control" placeholder="Detail" type="text" id="detail1" name="detail[]">'+
		            '<!--<span><i>Note: Add values (comma separated)</i></span>-->'+
		        '</div>'                            +
		    	'</div>'                       + 
				'</div>'+

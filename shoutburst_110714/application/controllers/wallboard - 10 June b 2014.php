...
class Wallboard extends CI_Controller {
	...
	public function  wallboard_launch()
	{
		...
		$query	=	"SELECT MAX(score) high_score,agent_name , logo FROM
					(SELECT SUM(average_score) AS score, u.full_name AS agent_name, u.photo AS logo
					FROM surveys s
	...
	public function congrats()
	{
		$data = $_COOKIE['data'];
		var_debug($data);exit;
		$this->load->view("wallboard/congrats",json_decode($data));
	}

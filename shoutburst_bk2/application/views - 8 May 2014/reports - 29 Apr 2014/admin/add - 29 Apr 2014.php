...
$(document).ready(function(){	
	...
	$("#report_type").change(function()
	{
		...
		if ( (value == "bar chart") || (value == "line graph") || (value == "pie chart") ){
			$('#assigned').show();
			$('#output_requirements_div').hide();
			$("#op_req option[value='data']").attr('selected', 'selected');
			$('#email_tr').hide();
			$('#ftp_tr').hide();
		}else{
			$('#assigned').hide();
			$('#output_requirements_div').show();
	...
	function validateCustomDateRange(step){
		...
		if(step==2){
			...
			if(report_period=='custom'){
				...
				//check err msg
				if(errMessage!=''){
					jQuery('#customDateErr').html('<div style="color:red;">'+errMessage+'</div>');
...
<?php echo form_open_multipart('reports/', array('name'=>'add_report', 'id'=>'add_report', 'onsubmit'=>"return check_it(this)")) ?><?php echo $this->session->flashdata('message');?>
<div id="content">
<div class="container">
<div id="report_content" class="cf"><!--<input type="button" onclick="gen_pdf()" value="PDF" />-->
    <!-- Step 1 -->
    <div id="step_1">
        <div class="row content-header"> <?php echo heading('Report Creation', 1);?> </div>
        <!-- .row -->
            ...
            <div class="col-sm-6">
                <div class="form-horizontal sb-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="" name="report_name" id="report_name" class="sb-control" placeholder="Report name" />
                    ...
                    <div class="form-group customDateRegion" style='display:none;'>
                        <label class="col-sm-6 control-label" for="report_period"></label>
                        <div class="col-sm-6">
                            <div>
                                <label style>Start Date</label>
                                <input type="text" name='start_date' id="datepicker" class='datePicker'>
                            </div>
                            <div>
                                <label>End Date</label>
                                <input type="text"  name='end_date' id="datepicker2" class='datePicker'>
                            </div>
                    ...
                    <div class="form-group customDayRegion" style='display:none;'>
                        ...
                        <div class="col-sm-6">
                            <div>
                                ...
                                <input type="text" name='custom_date' id="custom_date" class='datePicker'>
                            </div>
                    ...
                    <div class="form-group" id="output_requirements_div" style="display:none;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            ...
                            <input type="button" class="sb-btn sb-btn-green" value="Next" name="btn_step_2" id="btn_step_2" onclick="next_step(2); setXAxisLabel(); " />
                        </div>
                    </div>
                </div>
    ...
    <div id="step_2" style="display:none;">
        <div class="row content-header"> <?php echo heading('Data Control', 1);?> </div>
        <!-- .row -->
        <div class="row content-body">
            <div class="col-sm-12">
                <div class="row dragdrop-wrap data-control">
					...
					<div class="col-sm-6">
					  <h3 class="hidden-xs">Drop here</h3>
					  <div class="row">
						<div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-horizontal sb-form">
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <input type="button" class="sb-btn sb-btn-white" value="Back" name="btn_step_1" id="btn_step_1" onclick="next_step(1);" />
                                </div>
                                <div class="col-xs-6">
    ...
    <div id="step_3" style="display:none;">
        <div class="row content-header"> <?php echo heading('Filter', 1);?> </div>
        <!-- .row -->
        <div class="row content-body">
            <div class="col-sm-12">
                <div class="row">
                ...
                <div class="_extraPersonTemplate">
                    <div class="controls controls-row">
                        <div class="form-group row">
                ...
                <a href="#" id="addRow"><i class="icon-plus-sign icon-white"></i> Add
                </p>
                </a>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-horizontal sb-form">
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="button" class="sb-btn sb-btn-white" value="Back" name="btn_step_2" id="btn_step_2" onclick="next_step(2);">
                                </div>
                                <div class="col-xs-6">
    ...
    <div id="step_4" style="display:none;">
        <div class="row content-header"> <?php echo heading('Report Stylesheet', 1);?> </div>
        <!-- .row -->
        <div class="row content-body">
            <div class="col-sm-6">
                <div class="form-horizontal sb-form">
                ...
                <div class="form-horizontal sb-form" id="x_axis_label_div">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="" name="x_axis_label" id="x_axis_label" class="sb-control" readonly="readonly" placeholder="X Axis Label" />
                ...
                <div class="form-horizontal sb-form">
                    <div class="form-group">
                        <div class="col-xs-6">
                            <input type="button" class="sb-btn sb-btn-white" value="Back" name="btn_step_3" id="btn_step_3" onclick="next_step(3);">
                        </div>
                        <div class="col-xs-6">
                            <input type="button" class="sb-btn sb-btn-green query_builder" value="Next" name="btn_step_5" id="btn_step_5" onclick="next_step(5); ">
                        </div>
                    </div>
                </div>
                <!-- .form-horizontal .sb-form -->
    ...
    <div id="step_5" style="display:none;">
        <div class="row content-header"> <?php echo heading('Report Preview', 1);?> </div>
        <!-- .row -->
        <div class="row content-body">
            <div class="col-sm-12">
                <div class="form-horizontal sb-form querySaveDivRegion">
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            ...
                            <input type="button" class="sb-btn sb-btn-white" value="Back" name="btn_step_4" id="btn_step_4" onclick="next_step(4); clearContent(); liveChartIntervalRemove();">
                        </div>
                        <div class="col-xs-6">
                            <input type="button" class="sb-btn sb-btn-green reportSave" value="Save" name="btn_step_save" id="btn_step_save" onclick="next_step('save'); liveChartIntervalRemove();">

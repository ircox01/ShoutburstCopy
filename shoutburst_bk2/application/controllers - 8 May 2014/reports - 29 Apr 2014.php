...
class Reports extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->general = array('Dialed Number','CLI','Campaign');
		$this->score = array('Q1 Score','Q2 Score','Q3 Score','Q4 Score','Q5 Score','Total Score','Average Score');
	...
	public function query_builder()
	{
		...
		$where = implode(" ", $where);
		#$where = 'WHERE'.substr($where, strlen($post['condition'][0])) . ' AND acc_id = '.COMP_AGENT;

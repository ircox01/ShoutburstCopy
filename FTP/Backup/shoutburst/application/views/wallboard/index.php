                        ...
                        <div class="form-inlin">
							...
							?>
	                            <div class="wallboard-title form-group <?php echo (!empty($wb_info) && ($k['wb_id'] == $wb_info[0]->wb_id))?'active':''?>">
	                                <a href="<?php echo base_url().'wallboard/edit/'.$k['wb_id']?>">
	                                <div class="col-xs-7">
	                                ...
	                                <div class="col-xs-3">
	                                    ...
	                                    <?php
	                                    	if($launch_counter == 0) {
												$slug = preg_replace("/[\s_]/", "-", $k['title']);
										?>
	                                	<button type="button" class="btn btn-primary launch_wb" onclick="javascript:launch('<?php echo base_url().'wallboard/launch/'.$slug?>');">Launch</button>
	                                	<?php
	                                		}
											$launch_counter++;
	                                    ?>
                            ...
                            <div class="wallboard-title form-group <?php echo empty($wb_info)?'active':''?>">
                               <a href="<?php echo base_url().'wallboard';?>"> <div class="col-xs-7">
                        ...
                        <?php echo form_open_multipart($action, array('name'=>'wallboard', 'id'=>'wallboard', 'onsubmit'=>"return check_it(this)")) ?>
	                            ...
	                            <div class="form-group">
									...
									<?php if (!empty($wb_info)){?>
	                                    <button type="button" class="btn btn-primary-red delete_wb">Delete</button>
	                                <?php }?>
	                                </div>

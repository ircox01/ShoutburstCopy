...
<?php
			...
			<div class="row">
				...
				<div class="form-horizontal sb-form">
					<div class="form-group">
						<div class="col-xs-6"><input type="button" class="btn btn-primary" value="Back" name="btn_step_1" id="btn_step_1" onclick="next_step(1,2);" /></div>
						<div class="col-xs-6">
...
?>
			...
			<p><a href="#" class="report-filter-icon-add-row" id="addRow"><span class="glyphicon glyphicon-plus-sign green"></span></a></p><br/> 
			<div class="row">
  			  <div class="col-sm-6">
				<div class="form-horizontal sb-form">
					<div class="form-group">
    	...
    	<div class="row content-body">
			<div class="col-sm-12">
				<div class="form-horizontal sb-form querySaveDivRegion">
				  <div class="form-group">
					<div class="col-xs-6">
						<input type="button" class="btn btn-primary" value="Back" name="btn_step_4" id="btn_step_4" onclick="next_step(4,5); clearContent(); liveChartIntervalRemove();">

					</div>
					<div class="col-xs-6">
					 		<input type='hidden' name='report_id' value='<?php if(isset($reportId)){echo $reportId;}?>'/>
					 		<input type="button" class="btn btn-primary-green reportSave" value="Update Report" name="btn_step_save" style='float:right;' id="btn_step_save" onclick="next_step('update',5); ">

...
<div id="content">
  <div class="container">
    <div class="row content-header">
      <?php echo anchor("companies","Back", array('class'=>('sb-btn btn-primary-red'))); ?>
      <h1>Edit Company</h1>
    </div>
    <!-- .row -->
       ...
       <!--  <div class="form-group">
        ...
        <div class="form-group">
          <div style="display:none;" id="new-campiagn-region">
            ...
            <div class="form-group"><input type="text" id="addNewCampaignMaxQ" placeholder="Campaign Max Qs" class="sb-control span3 input-large"></div>
        ...
        <div class="form-horizontal sb-form">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
            <label for="highest_score"class="col-sm-6 control-label">Highest Score</label>
            <div class="col-sm-6">
              <input type="text" class="sb-control" value="<?php echo isset($company[2]->highest_score) ? $company[2]->highest_score : ''?>" name="highest_score" id="highest_score" maxlength="10" />
            </div>
          </div>
        </div>
        <!-- .form-horizontal -->
...
jQuery("#accounteditform").validate({
	...
	messages: {			
		...
		highest_score:{
			required:"Please enter Highest score"}
	}

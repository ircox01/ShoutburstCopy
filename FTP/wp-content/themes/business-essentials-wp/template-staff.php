...
query_posts('post_type=staff&posts_per_page=16&paged='. $paged . '&order=ASC' ); ?>
...
<a href="<?php the_permalink (); ?>"><?php echo wp_get_attachment_image($staffheadshot, array(216,281)); ?></a>

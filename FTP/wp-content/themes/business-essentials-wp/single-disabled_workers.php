...
<!-- Start of disabled_worker print -->
<div class="disabled_worker_print">

<a href="javascript:window.print()"><?php echo stripslashes($printicontext); ?></a>

</div><!-- End of disabled_worker print -->

<div class="disabled_worker_split"></div>
...
<?php get_sidebar ('disabled_workers'); ?> 

...
<style>
body{ width: 650px; height: 300px; }
.title_comp{ font-size: 11px; font-family: "Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif; padding-left: 10%; text-align: center; }
.logo_comp{ width: 40%; float: left; }
.logo_comp img{ width: 100px; height: 100px; display: block; margin: 0 auto; }
.svg_cloud{ padding-top: -10px; display: block; margin: 0 auto; }
</style>
</head>
<body>
...
<script>
  ...
  d3.layout.cloud().size([300, 250])
      .words(nonaa.map(function(d) {
        return {text: d.valuee, size: 10 + (Math.random() * 2) * 9 };
      }))
      .padding(3)

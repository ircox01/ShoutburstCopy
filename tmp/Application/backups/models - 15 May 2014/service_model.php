...
class Service_model extends CI_Model {
	...
	public function updateSurveyScore($questions='', $total_score='' , $average_score='' , $action='' , $callid='')
	{
		$query = "UPDATE surveys SET $questions, total_score=$total_score, average_score=$average_score , action='".$action."', processed=1 WHERE sur_id=".$callid;

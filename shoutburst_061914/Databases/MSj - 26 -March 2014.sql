...
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (6,'Helgi Campaign','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (7,'Campaign 1',NULL,NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (8,'Campaign 6',NULL,NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (9,'WPA Campaign 1','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (10,'1',NULL,NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (11,'9',NULL,NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (12,'New Campaign','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (13,'Sample Campaign','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (14,'Sample Campaign 1','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (15,'Sample Campaign 2','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (16,'Sample Campaign 3','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (17,'Sample campaign 4','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (18,'WPA Campaign 2','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (19,'Sample Campaign 5','2014-03-24',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (20,'Helgi Campaign 1','2014-03-25',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (21,'TCO1','2014-03-26',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (22,'Hello','2014-03-26',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (23,'GTA','2014-03-26',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (24,'GTA 1','2014-03-26',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (25,'GTA 3','2014-03-26',NULL,1);
insert  into `campaigns`(`camp_id`,`camp_name`,`created`,`last_change`,`status`) values (26,'CS1','2014-03-26',NULL,1);
...
insert  into `companies`(`comp_id`,`comp_name`,`created`,`last_change`,`logo`,`platform`,`transcribe`,`status`) values (4,'Helgi','2014-03-24',NULL,'wpa-smile1.jpg','Helgi Platform',1,1);
insert  into `companies`(`comp_id`,`comp_name`,`created`,`last_change`,`logo`,`platform`,`transcribe`,`status`) values (5,'WPA','2014-03-24',NULL,'feedburner.png','WPA Platform',1,1);
...
insert  into `company_campaings`(`comp_id`,`camp_id`) values (1,6);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (4,7);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (4,8);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (1,9);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (5,10);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (5,11);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (5,18);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (1,19);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (4,20);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (2,21);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (2,22);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (2,23);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (2,24);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (2,25);
insert  into `company_campaings`(`comp_id`,`camp_id`) values (1,26);
...
insert  into `dashboards`(`db_id`,`user_id`,`comp_id`,`acc_id`,`db_type`,`db_query`) values (5,23,2,3,'default','SELECT c.camp_name, u.user_id, u.full_name, s.total_score\r\n			    		FROM surveys s\r\n			    		JOIN campaigns c ON s.camp_id = c.camp_id\r\n			    		JOIN users u ON s.user_id = u.user_id\r\n			    		WHERE s.user_id = 23 AND s.total_score > 0\r\n			    		ORDER BY c.camp_name');
insert  into `dashboards`(`db_id`,`user_id`,`comp_id`,`acc_id`,`db_type`,`db_query`) values (6,24,5,2,'default','SELECT c.camp_name, u.user_id, u.full_name, s.total_score\r\n			    		FROM surveys s\r\n			    		JOIN campaigns c ON s.camp_id = c.camp_id\r\n			    		JOIN users u ON s.user_id = u.user_id\r\n			    		WHERE s.user_id = 24 AND s.total_score > 0\r\n			    		ORDER BY c.camp_name');
insert  into `dashboards`(`db_id`,`user_id`,`comp_id`,`acc_id`,`db_type`,`db_query`) values (7,25,5,3,'default','SELECT c.camp_name, u.user_id, u.full_name, s.total_score\r\n			    		FROM surveys s\r\n			    		JOIN campaigns c ON s.camp_id = c.camp_id\r\n			    		JOIN users u ON s.user_id = u.user_id\r\n			    		WHERE s.user_id = 25 AND s.total_score > 0\r\n			    		ORDER BY c.camp_name');
insert  into `dashboards`(`db_id`,`user_id`,`comp_id`,`acc_id`,`db_type`,`db_query`) values (8,26,5,4,'default','SELECT c.camp_name, u.user_id, u.full_name, s.total_score\r\n			    		FROM surveys s\r\n			    		JOIN campaigns c ON s.camp_id = c.camp_id\r\n			    		JOIN users u ON s.user_id = u.user_id\r\n			    		WHERE s.user_id = 26 AND s.total_score > 0\r\n			    		ORDER BY c.camp_name');
insert  into `dashboards`(`db_id`,`user_id`,`comp_id`,`acc_id`,`db_type`,`db_query`) values (9,27,2,4,'default','SELECT c.camp_name, u.user_id, u.full_name, s.total_score\r\n			    		FROM surveys s\r\n			    		JOIN campaigns c ON s.camp_id = c.camp_id\r\n			    		JOIN users u ON s.user_id = u.user_id\r\n			    		WHERE s.user_id = 27 AND s.total_score > 0\r\n			    		ORDER BY c.camp_name');
insert  into `dashboards`(`db_id`,`user_id`,`comp_id`,`acc_id`,`db_type`,`db_query`) values (10,28,4,3,'default','SELECT c.camp_name, u.user_id, u.full_name, s.total_score\r\n			    		FROM surveys s\r\n			    		JOIN campaigns c ON s.camp_id = c.camp_id\r\n			    		JOIN users u ON s.user_id = u.user_id\r\n			    		WHERE s.user_id = 28 AND s.total_score > 0\r\n			    		ORDER BY c.camp_name');
...
insert  into `tags`(`tag_id`,`comp_id`,`tag_name`,`camp_ids`,`details`,`data_set`,`score`,`status`) values (9,5,'WPA Tag 1','0','\"B\"','score_levels','[\"6\",\"3\"]',1);
insert  into `tags`(`tag_id`,`comp_id`,`tag_name`,`camp_ids`,`details`,`data_set`,`score`,`status`) values (10,5,'WPA Tag 2','0','\"B\"','score_levels','[\"0\",\"3\"]',1);
insert  into `tags`(`tag_id`,`comp_id`,`tag_name`,`camp_ids`,`details`,`data_set`,`score`,`status`) values (11,4,'Helgi Tag 1','[\"20\"]','\"true\"','sentiment',NULL,1);
insert  into `tags`(`tag_id`,`comp_id`,`tag_name`,`camp_ids`,`details`,`data_set`,`score`,`status`) values (12,2,'GTA Tag','[\"24\",\"25\"]','[\"18\",\"19\",\"20\"]','agents',NULL,1);
...
insert  into `tags_group`(`tg_id`,`comp_id`,`tg_name`,`tag_ids`) values (7,5,'WPA Group Tag 1','[\"9\"]');
insert  into `tags_group`(`tg_id`,`comp_id`,`tg_name`,`tag_ids`) values (8,4,'Helgi Group tag 1','[\"11\"]');
...
insert  into `target_setup`(`comp_id`,`survey_per_day`,`avg_total_score`,`incorrpletes_per_day`,`nps_score`,`max_per_day`,`day_start_time`,`day_end_time`) values (4,2,5,5,5,5,'0000-00-00 00:00:00','0000-00-00 00:00:00');
insert  into `target_setup`(`comp_id`,`survey_per_day`,`avg_total_score`,`incorrpletes_per_day`,`nps_score`,`max_per_day`,`day_start_time`,`day_end_time`) values (5,5,5,0,5,5,'0000-00-00 00:00:00','0000-00-00 00:00:00');
...
insert  into `user_companies`(`user_id`,`comp_id`,`acc_id`,`user_pin`) values (22,4,2,'');
insert  into `user_companies`(`user_id`,`comp_id`,`acc_id`,`user_pin`) values (23,2,3,'12345');
insert  into `user_companies`(`user_id`,`comp_id`,`acc_id`,`user_pin`) values (24,5,2,NULL);
insert  into `user_companies`(`user_id`,`comp_id`,`acc_id`,`user_pin`) values (25,5,3,'12345');
insert  into `user_companies`(`user_id`,`comp_id`,`acc_id`,`user_pin`) values (26,5,4,'agent-sam');
insert  into `user_companies`(`user_id`,`comp_id`,`acc_id`,`user_pin`) values (27,2,4,'ahmed-pin');
insert  into `user_companies`(`user_id`,`comp_id`,`acc_id`,`user_pin`) values (28,4,3,'jirka');
...
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (17,'Arshad','arshad@nextgeni.com','arshad@nxd.com','1d0258c2440a8d19e716292b231e3190','2014-03-10','1nqN9cHYTo1dIPX7UU9468xsxdIu44Iu.jpg',0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (18,'Usman','usman','usman@nxd.com','b33aed8f3134996703dc39f9a7c95783','2014-03-11','mWZS5Y89yx0o34WV8o64xU1k8wJL8094.jpg',0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (19,'Ali','ali','ali@nxd.com','b33aed8f3134996703dc39f9a7c95783','2014-03-11',NULL,0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (20,'Jawwad','jawwad','jawwad@nxd.com','b33aed8f3134996703dc39f9a7c95783','2014-03-11',NULL,0,1);
...
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (22,'helgi@sb.com','helgi','admin@helgi.com','21232f297a57a5a743894a0e4a801fc3','2014-03-24',NULL,0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (23,'Shumaila','shumaila','shumaila@nxd.com','1d0258c2440a8d19e716292b231e3190','2014-03-24','z32SgVLe9e13Czx38YqFukW1a697KfrK.jpg',0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (24,'Josh','Josh','josh@wpa.com','541693348a0de2d5a008acca982614ec','2014-03-24',NULL,0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (25,'Sara','sara','sara@wpa.com','1d0258c2440a8d19e716292b231e3190','2014-03-24','KI0YAdoe828XA6bCn0dps541uvs0r7yC.jpg',0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (26,'Sam','sam','sam@wpa.com','b33aed8f3134996703dc39f9a7c95783','2014-03-24','',0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (27,'Ahmed','ahmed','ahmed@nxd.com','b33aed8f3134996703dc39f9a7c95783','2014-03-25','',0,1);
insert  into `users`(`user_id`,`full_name`,`user_name`,`email`,`password`,`created`,`photo`,`transcriber`,`status`) values (28,'Jirka','jirka','jirka@helgi.com','1d0258c2440a8d19e716292b231e3190','2014-03-25','9Mc8KLL1orVM54XD53NHu499o26me1Xv.jpg',0,1);

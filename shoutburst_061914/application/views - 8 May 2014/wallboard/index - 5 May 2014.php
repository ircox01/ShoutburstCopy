                    ...
                    <div class="form-horizontal sb-form">
                        ...
                        <?php echo form_open_multipart($action, array('name'=>'wallboard', 'id'=>'wallboard', 'onsubmit'=>"return check_it(this)")) ?>
	                            <div class="form-group">
	                                ...
	                                <div class="col-xs-8">
	                                    <input type="text" class="sb-control" id="title" name="title" value="<?php echo $title?>">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-xs-4">
	                                    <input type="text" class="txtTesting sb-control sb-time-size" id="time" name="screen_delay" maxlength="2" value="<?php echo $screen_delay?>">
	                                </div>
	                            </div>
	                            <div class="form-group">
...
<!-- #content -->
<script type="text/javascript">$(".txtTesting").jStepper({minValue:1, maxValue:10, minLength:1});</script>

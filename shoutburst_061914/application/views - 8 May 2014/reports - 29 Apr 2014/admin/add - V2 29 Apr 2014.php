 ...
 jQuery(document).ready(function() {
	...
	function validateCustomDateRange(step){
		...
		if(step==2){
			...
			else if(report_period=='custom'&&report_type!='detail'){
				var errMessage	= "";
...
<div id="report_content" class="cf"><!--<input type="button" onclick="gen_pdf()" value="PDF" />-->
    ...
    <div id="step_1">
        <div class="row content-header">        
	        <a class="sb-btn sb-btn-blue" onclick="report_list(); clearContent(); liveChartIntervalRemove(); return false;" href="javascript:;">Cancel</a>
                    ...
                    <div class="customDateRegion" style='display:none;'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 sb-date-picker">
                                <input type="text" name='start_date' id="datepicker" class='sb-control datePicker'>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div id="step_2" style="display:none;">
        <div class="row content-header"> <?php echo heading('Data Control', 1);?>
        <div style='float:right; padding-right:10px;'><a class="btn btn-primary" onclick="report_list(); clearContent(); liveChartIntervalRemove(); return false;" href="javascript:;">Cancel</a></div> </div>
        <!-- .row -->
        <div class="row content-body">
            <div class="col-sm-12">
    ...
    <div id="step_3" style="display:none;">
        <div class="row content-header"> <?php echo heading('Filter', 1);?><div style='float:right; padding-right:10px;'><a class="btn btn-primary" onclick="report_list(); clearContent(); liveChartIntervalRemove(); return false;" href="javascript:;">Cancel</a></div> </div>
        <!-- .row -->
        <div class="row content-body">
            <div class="col-sm-12">
                <div class="row">
    ...
    <div id="step_4" style="display:none;">
        <div class="row content-header"> <?php echo heading('Report Stylesheet', 1);?>
        <div style='float:right; padding-right:10px;'><a class="btn btn-primary" onclick="report_list(); clearContent(); liveChartIntervalRemove(); return false;" href="javascript:;">Cancel</a></div> </div>
        <!-- .row -->
        <div class="row content-body">
            <div class="col-sm-6">
    ...
    <div id="step_5" style="display:none;">
        <div class="row content-header"> <?php echo heading('Report Preview', 1);?>

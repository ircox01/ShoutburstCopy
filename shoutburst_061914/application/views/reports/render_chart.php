...
{
$html .=<<<HTML
        <img src='$logo' width="100" height="100" class="shadow" style="position: absolute; top: 15px; right: 15px;z-index:999;">
HTML;
}else
{
...
?>
<div id="container2" style="min-width: 500px; height: 510px; margin: 0 auto"></div>

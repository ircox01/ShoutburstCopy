...
<?php echo $this->session->flashdata('message');?>
	...
	<div class="form-group row">
		...
		<div class="col-md-3"><input tabindex="2" id="ssHp" type="radio" class="sb-radio" name="sentiment_score" checked="checked" <?php echo ($transcription[0]['sentiment_score'] == 'hp')?'checked="checked"':''?> value="	hp"><label for="ssHp"><span></span></label></div>
	</div>
	<div class="form-group row">

...
<div class="modal-body">
	...
	<div class="form-group">
		<input type="text" value="<?php echo isset($user[0]->user_pin) ? $user[0]->user_pin : ''?>" name="user_pin" id="user_pin" class="sb-control" placeholder="User Pin"  maxlength="4" >
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<div class="panel panel-sb">
		  ...
		  <div class="panel-body">
			  <select name="tags[]" id="tags" class="sb-control" >
				<?php
				foreach ($tags as $t)
				{
					$selected = '';

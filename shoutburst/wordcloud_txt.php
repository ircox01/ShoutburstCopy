...
<body>
  ...
  if ($has_logo) {
  ?>
	<span style='float:right;'><img class='comp_logo' src='company_logo/<?=$logo?>' /></span>
	<?php
    ...
    <form id="form" method="get" action="" style='margin:0px;'>
      <div class="row">
	  	<span style='font-family: "Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif;font-size:18px;'><?=$chart_title?></span>

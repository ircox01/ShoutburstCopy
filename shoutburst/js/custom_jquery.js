...
jQuery(document).ready(function(){
	   ...
	   //show add campaign region
		...
		function addNewCampaign(){
			...
			var maxQuestions = jQuery.trim(jQuery('#addNewCampaignMaxQ').val());
			...
			if (maxQuestions==''){
				error += 'Please Enter Valid Max Questions';
			}
			...
			if(error!=''){			
				...
				jQuery.ajax({
							type: "POST",
							url: urlPath,
							data:"camp_name="+addNewCampaign+"&routingPlan="+routingPlan+"&maxQuestions="+maxQuestions,
							cache:false,

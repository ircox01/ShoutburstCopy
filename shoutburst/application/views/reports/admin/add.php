        ...
        <div id="report_content" class="cf"><!--<input type="button" onclick="gen_pdf()" value="PDF" />-->
            ...
            <div id="step_1">
                <div class="row content-header">
                    <a class="sb-btn btn-primary-red"
                    ...
                    <div class="col-sm-6">
                        <div class="form-horizontal sb-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="" name="report_name" id="report_name" class="sb-control"
                                ...
                                <div class="col-sm-6">
                                    <select id="report_type" class="sb-control" name="report_type">
                                        <?php foreach ($report_types as $rt) { ?>
                                            <option
                                                value="<?php echo strtolower($rt->type_name) ?>"><?php echo $rt->type_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <select id="report_period" class="sb-control" name="report_period"
                                        ...
                                        <?php foreach ($report_periods as $rp) { ?>
                                            <option
                                                value="<?php echo strtolower($rp->rep_prd_name) ?>"><?php echo $rp->rep_prd_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <select id="report_interval" class="sb-control" name="report_interval">
                                        <?php foreach ($report_intervals as $ri) { ?>
                                            <option
                                                value="<?php echo strtolower($ri->rep_interval_name) ?>"><?php echo $ri->rep_interval_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="email_tr" style="display:none;">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="email_address" rows="3" cols="10" class="sb-textarea"
                                              placeholder="Add email addresses [comma separated] ..."></textarea>
                                </div>
                            </div>
                            <!-- #email_tr -->
            ...
            <div id="step_2" style="display:none;">
                <div class="row content-header">
                    <a class="sb-btn sb-btn-white" onclick="report_list(); clearContent();  return false;"
                       href="javascript:;">Cancel</a>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-horizontal sb-form">
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <input type="button" class="btn btn-primary" value="Back" name="btn_step_1"
                                                   id="btn_step_1" onclick="next_step(1,2);"/>
                                        </div>
                                        <div class="col-xs-6">
            ...
            <div id="step_3" style="display:none;">
                ...
                <div class="row content-body">
                    <div class="col-sm-12">
                        ...
                        <div class="_extraPersonTemplate relative">
                            <div class="controls controls-row">
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-3">
                                        <input class="span3 sb-control" placeholder="Detail" type="text" id="detail"
                                               name="detail[]"><span id="detailbox"></span>
                        ...
                        <a href="#" class="report-filter-icon-add-row" id="addRow"><span
                                class="glyphicon glyphicon-plus-sign green"></span></p></a>
                                ...
                                <div class="form-horizontal sb-form">
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            ...
                                            <input type="button" class="btn btn-primary" value="Back" name="btn_step_2"
                                                   id="btn_step_2" onclick="next_step(2,3);">
                                        </div>
                                        <div class="col-xs-6">
                                            <input type="button" class="btn btn-primary-green" value="Next"
                                                   name="btn_step_4" id="btn_step_4" onclick="next_step(4);">
                                        </div>
                                    </div>
                                </div>
                                <!-- .form-horizontal .sb-form -->
                    ...
                    <div class="col-sm-6">
                        <div class="form-horizontal sb-form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="" name="background_color" id="background_color"
                                           class="custom-color-picker" placeholder="Background Colour"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-horizontal sb-form" id="x_axis_label_div">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="" name="x_axis_label" id="x_axis_label" class="sb-control"
                                           readonly placeholder="X Axis Label"/>
                                    ...
                                    <select name="y_axis_label" id="y_axis_label" class="sb-control">
                                        ...
                                        if (!empty($yAxisColoumnList)) {
                                            foreach ($yAxisColoumnList as $coloumnName => $yAxisColoumnRow) {
                                                ?>
                                                <option
                                                    value="<?php echo $coloumnName;?>"><?php echo $yAxisColoumnRow;?></option>
                                            <?php
                                            }
                                        }
                                        ?>
                        ...
                        <div class="form-horizontal sb-form" id="y_axis_midpoint_div">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" value="" name="y_axis_midpoint" id="y_axis_midpoint"
                                           class="sb-control" placeholder="0"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-horizontal sb-form">
                        ...
                        <div class="form-horizontal sb-form">
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <input type="button" class="btn btn-primary" value="Back" name="btn_step_3"
                                           id="btn_step_3" onclick="next_step(3,4);">
                                </div>
                                <div class="col-xs-6">
                                    <input type="button" class="btn btn-primary-green query_builder" value="Next"
                                           name="btn_step_5" id="btn_step_5" onclick="next_step(5,4); ">
                                </div>
                            </div>
                        </div>
                        <!-- .form-horizontal .sb-form -->
            ...
            <div id="step_5" style="display:none;">
                <div class="row content-header">
                    ...
                    <a href='javascript:;' onClick='report_list(); clearContent();  return false;'
                       class='sb-btn sb-btn-white'>Cancel</a>
                    ...
                    <div class="col-sm-12">
                        <div class="form-horizontal sb-form querySaveDivRegion">
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <input type="button" class="sb-btn sb-btn-white" value="Back" name="btn_step_4"
                                           id="btn_step_4" onclick="next_step(4,5); clearContent(); ">

                                    <div style="display:none;"><textarea id="report_html" name="report_html"></textarea>
                                    </div>

                                </div>
                                <div class="col-xs-6">

                                    <input type="button" class="btn btn-primary-green reportSave" value="Save"
                                           name="btn_step_save" id="btn_step_save" style='float:right;'
                                           onclick="next_step('save',5); ">

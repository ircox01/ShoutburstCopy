...
if ($from_dash == 1) {
    $wciframe = "<iframe src='http://app.shoutburst.co.uk/d3Cloud.php?text=$text64&title=$wc_title'  width='100%' height='100%' style='overflow:hidden;' frameborder=0/>";
	//$wciframe = "<iframe src='http://localhost/shoutburst/wordcloud_txt_small.php?text=$text64&title=$wc_title' width='100%' height='100%' style='overflow:hidden;' frameborder=0/>";
} else {
	$wciframe = "<iframe src='http://app.shoutburst.co.uk/d3Cloud_Large.php?text=$text64&logo=$logo&title=$wc_title' height=580 width=1270 frameBorder='0' style='overflow:hidden;'/>";
	//$wciframe = "<iframe src='http://localhost/shoutburst/wordcloud_txt.php?text=$text64&logo=$logo&title=$wc_title' height=580 width=1270 frameBorder='0' style='overflow:hidden;'/>";
}
...
?>
                 <iframe scrolling="yes" width="100%" height="90%" style="border: 0px;"

...
<div class="modal-body">
	...
	<div class="form-group">
		...
		<img id="tempimg" style='border:1px solid black;' src="<?php echo isset($user[0]->photo) ? base_url().USER_PHOTO.'/'.$user[0]->photo :  base_url().USER_PHOTO.'/noImageUploaded.png'?>" width="35%" height="35%">
		<input type="file" value="" name="user_photo" id="user_photo" class="sb-file" onChange="loadImg(this);" placeholder="User photography">
	</div>
</div><!-- .modal-body -->

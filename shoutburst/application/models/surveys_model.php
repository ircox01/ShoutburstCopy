...
class Surveys_model extends CI_Model {
	...
	public function insert_survey($sur_id,$comp_id,$user_id){
		...
		if ($sur_id == -1) {
			...
			$avrg = $total/5;
			$sql_query = "INSERT INTO `surveys`( `comp_id`, `user_id`, `camp_id`, `dialed_number`, `date_time`, `cli`, `q1`, `q2`, `q3`, `q4`, `q5`, `total_score`, `average_score`,`nps_question`, `http_icon`, `action`, `recording`, `ftp_path`, `comments`, `servicenumber`, `plan`, `downloaded`, `recorded`, `processed`, `max_q1`, `max_q2`, `max_q3`, `max_q4`, `max_q5`) VALUES ($comp_id,$user_id,$avrg,NULL,NOW(),NULL,$q1,$q2,$q3,$q4,$q5,$total,8,1,NULL,NULL,0,1,0,0,0,0,0,0,0,5,5,5,5)";
		}

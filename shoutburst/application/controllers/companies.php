...
class Companies extends CI_Controller {
	...
	public function account_setup()
	{
		...
		if(isset($_POST) && !empty($_POST))
		{
			...
			{				
				...
				if ( $this->send_email($post['adminname'],$post['adminemail'],$post['password']) )
				{
	...
	private function send_email( $name='', $to='', $password='' )
	{
		...
		$message = "Hi ".ucwords($name).", Your account has been created. Your login credentials are <br /><br /> User name:".strtolower($name)."<br />Password:".$password;
		/*var_debug($headers);
		var_debug($message);
		exit;*/

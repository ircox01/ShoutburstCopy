			...
			for ($d=1; $d<=4; $d++)
			{
				...
				if ($report_id > 0)
				{
					...
					if (!empty($the_report) )
					{
						...
						$data['report_type'][$d] = $the_report['report_type'];
						$data['columns_name'][$d] = $the_report['columns_name'];
						$data['background_color'][$d] = $the_report['background_color'];
						$data['report_query'][$d] = $the_report['report_query'];

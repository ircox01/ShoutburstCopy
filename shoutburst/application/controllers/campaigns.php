...
class Campaigns extends CI_Controller {
	...
	public function add($ajaxRequested = null)
	{
		...
		if (isset($post) && !empty($post))
		{
			...
			$max_questions = $post['maxQuestions'];
			...
			if ( empty($return) )
			{
				...
				$this->db->insert('campaigns', array('camp_name'=>$camp_name,'routing_plan'=>$routing_plan, 'max_questions'=> $max_questions, 'created'=>date('Y-m-d')));

...
<?php echo $this->Form->create('RecordingEmail'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Recording Email'); ?></legend>
	<?php
	...
	?>
		...
		<div  id="_recordingEmailDiv" class="input text required">
...
<script  type="text/javascript">
	 $( document ).ready(function() {
		i = $('#_recordingEmailDiv p').size() + 1;
		$('#_addContant').click(function() {
			$('<p><input id="RecordingEmailAdds" type="text" required="required" maxlength="500" name="data[RecordingEmail][email_adds][]"><a type="button"  class="_rem btn btn-primary btn-small" name="id'+ i + '"onclick="return false;">Remove</a></p>').appendTo('#_recordingEmailDiv');
			i++;
			return false;
		});

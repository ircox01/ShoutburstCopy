	...
	<div class="table-responsive">
		<table class="table">
			...
			<tr>
				...
				<td><?php echo h($recording['Recording']['status']); ?>&nbsp;</td>
				<td class="actions">
					<!--?php echo $this->Html->link(__('View'), array('action' => 'view', $recording['Recording']['id']), array('class' => 'btn btn-warning')); ?-->
					<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $recording['Recording']['id']), array('class' => 'btn btn-warning')); ?>
					<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $recording['Recording']['id']), array('class' => 'btn btn-warning'), null, __('Are you sure you want to delete # %s?', $recording['Recording']['id'])); ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</table>
